const translations = {
  en: {
    ...
    installerText:
      "The native installer window keeps all maintenance actions in one place: install or uninstall, updates, opening the install folder, packaging icons, and icon re-scans.",
    ...
    pickerText:
      "The picker is organized into categories, supports search, shows live previews, and exposes import, delete, restore, and derived icon creation actions.",
    categoryLabel: "Category",
    iconsLabel: "Icons",
    searchLabel: "Search",
    previewLabel: "Preview",
    pickerPreviewText: "Current icon preview",
    pickerPreviewAlt: "Foldrion picker preview icon",
    editorKicker: "Editor",
    ...
    editorPreviewAlt: "Foldrion derived editor icon preview",
  ...
  pt: {
    ...
    installerText:
      "A janela nativa do instalador reúne as ações de manutenção em um só lugar: instalar ou desinstalar, atualizar, abrir a pasta de instalação, empacotar ícones e reescanear ícones.",
    installerDemoCaption:
    ...
    actionsLabel: "Ações",
    pickerKicker: "Seletor",
    pickerTitle: "Navegue por categorias, pesquise ícones e visualize escolhas.",
    pickerText:
      "O seletor é organizado em categorias, suporta busca, mostra previews ao vivo e expõe ações de importar, deletar, restaurar e criar ícones derivados.",
    categoryLabel: "Categoria",
    iconsLabel: "Ícones",
    searchLabel: "Busca",
    previewLabel: "Preview",
    pickerPreviewText: "Preview do ícone atual",
    pickerPreviewAlt: "Preview do ícone no seletor do Foldrion",
    editorKicker: "Editor",
    ...
    editorPreviewAlt: "Preview do editor derivado do Foldrion",
